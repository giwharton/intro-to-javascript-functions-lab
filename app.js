...
const isCharAVowel = (char) => {
  // Convert the input character to lowercase and check if it's a vowel
...
console.log('Exercise 4 Result:', generateEmail("johnsmith", "example.com")); // Output: johnsmith@example.com
...
console.log('Exercise 5 Result:', greetUser("Sam", "morning")); // Output: Good morning, Sam!
...
console.log('Exercise 6 Result:', maxOfThree(5, 10, 8)); // Output: 10
